...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-uvddl0c.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-uvddl0c.containers.anotherwebservice.com/
...
```
git clone git@github.com:meetkool/container-uvddl0c.git
cd container-uvddl0c
```
...
```
docker attach container-uvddl0c
```
